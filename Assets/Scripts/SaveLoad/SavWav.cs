//Diadrasis ©2023
#region	Copyright (c) 2012 Calvin Rien
...
namespace Diadrasis.Rethymno 
{
	...
	public class SavWav : MonoBehaviour
	{
        ...
        public static void SaveToPath(string filepath, string filename, AudioClip clip, bool withFileExtension, bool trim = false)
        {
        ...
        public static void SaveAudioClip(string filename, AudioClip clip, bool trim = false)
        {
            if (!filename.ToLower().EndsWith(".wav"))
            {
                filename += ".wav";
        ...
        public static void SaveAudioFromByteArray(string filename, byte[] bytes, bool withFileExtension, out bool isDone)
        {
            isDone = false;
            ...
            {
                filename = filename.WithNoExtension();
            }

            var filepath = Path.Combine(SaveLoadManager.GetPath_ForAudios(), filename);
