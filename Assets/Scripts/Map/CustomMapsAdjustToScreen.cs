...
namespace Diadrasis.Rethymno 
{
	...
	public class CustomMapsAdjustToScreen : MonoBehaviour
	{
        ...
        [Space]
        public RectTransform customScreenSizer;
        public bool useCustomScreen;

        private void GetScreenSize(out int width, out int height)
        {
            if(customScreenSizer != null && useCustomScreen)
            {
                width = Mathf.RoundToInt(customScreenSizer.GetWidth());
                height = Mathf.RoundToInt(customScreenSizer.GetHeight());
            }
        ...
        private void Start()
        {
            ...
            customScreenSizer.gameObject.SetActive(useCustomScreen);
